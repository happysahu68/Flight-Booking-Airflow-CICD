...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-gds-happy")
    bq_project = Variable.get("bq_project", default_var="vibrant-tiger-465811-u6")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "621636043206-compute@developer.gserviceaccount.coms",
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="vibrant-tiger-465811-u6",
        region="us-central1",
